            ...
            try {
                ...
                for (int i = 0; i < networksize; ++i) {
                    ...
                    if (query != null) {
                        ...
                        int cpt = res.size();
                        System.err.printf("[Peer-%d] has a query with %d/%d results. (see %d distinct peers)[%s] %n", snob.id, cpt, query.cardinality, snob.profile.alreadySeen.size(), snob.profile.alreadySeen.toArray().toString());

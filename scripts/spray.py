...
globalxappro3 = []
globalyappro3 = []
# x * n where x = ln(1 / (1-p)) where p = 0.75
globalxappro4 = []
globalyappro4 = []
...
for p in points:
    ...
    globalyappro.append(p[0] * (log(p[0]) + 0.5772156649) / log(p[0]))
    globalxappro2.append(p[0])
    globalyappro2.append(p[0] * log(1/(1-0.9999)) / log(p[0]))
    globalxappro3.append(p[0])
    globalyappro3.append(p[0] * log(1/(1-0.99)) / log(p[0]))
    globalxappro4.append(p[0])
    globalyappro4.append(p[0] * log(1/(1-0.75)) / log(p[0]))
...
ax.plot(globalxappro4, globalyappro4, color="purple", label="n*ln(1/(1-p)) with p=0.75")
ax.legend()
